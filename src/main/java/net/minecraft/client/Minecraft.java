...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public final MetadataSerializer metadataSerializer_ = new MetadataSerializer();
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new GameOver((ITextComponent)null);
        }
    ...
    public void runTick() throws IOException
    {
        ...
        {
            if (this.player.getHealth() <= 0.0F && !(this.currentScreen instanceof GameOver))
            {
                this.displayGuiScreen((GuiScreen)null);
            }
    ...
    public void setDimensionAndSpawnPlayer(int dimension)
    {
        ...
        if (this.currentScreen instanceof GameOver)
        {
            this.displayGuiScreen((GuiScreen)null);
        }
    }
