...
public class Woodthree
{
  private static final TextFormatting[] colour = { TextFormatting.GRAY, TextFormatting.GRAY, TextFormatting.GRAY, TextFormatting.GRAY, TextFormatting.GRAY };
