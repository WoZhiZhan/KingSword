...
public class EntityKingdefengkingdefengshen extends ElementsKingswordMod.ModElement {
	public static final int ENTITYID = 5;
	public static final int ENTITYID_RANGED = 6;
	public EntityKingdefengkingdefengshen(ElementsKingswordMod instance) {
		super(instance, 83);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("kingsword", "kingdefengkingdefengshen"), ENTITYID).name("kingdefengkingdefengshen").tracker(64, 3, true)
				.egg(-16777216, -10066330).build());
	}
	...
	public static class EntityCustom extends EntityMob {
		...
		protected Item getDropItem() {
			return new ItemStack(Items.GOLDEN_APPLE, (int) (1), 1).getItem();
		}
