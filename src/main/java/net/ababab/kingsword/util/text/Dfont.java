...
{
    private static Dfont font;

    public static Dfont getFont()
    {
        if (font == null)
        {
            Minecraft mc = Minecraft.getMinecraft();
            font = new Dfont(mc.gameSettings, new ResourceLocation("textures/font/ascii.png"), mc.renderEngine, false);
    ...
    private Dfont(GameSettings gameSettingsIn, ResourceLocation location, TextureManager textureManagerIn, boolean unicode)
    {
    ...
    public int drawStringWithShadow(String text, float x, float y, int color)
    {
        ...
        {
            int c = color & 0xFF000000 | MathHelper.hsvToRGB(huehuehue, 2F, 1.0F);
