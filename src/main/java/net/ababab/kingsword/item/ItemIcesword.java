...
public class ItemIcesword extends ElementsKingswordMod.ModElement {
	@GameRegistry.ObjectHolder("kingsword:icesword")
	public static final Item block = null;
	public ItemIcesword(ElementsKingswordMod instance) {
		super(instance, 627);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("kingsword:icesword", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add(Kingu.makeColour("在寒冰之中产生的剑"));
			list.add(Kingu.makeColour("斩破一切冰雪"));
		}

		@Override
		public String getItemStackDisplayName(ItemStack Stack)
 		{
    		return Nb3.makeColour("寒冰之刃");
  		}
