...
public class ItemIronsword extends ElementsKingswordMod.ModElement {
	@GameRegistry.ObjectHolder("kingsword:ironsword")
	public static final Item block = null;
	public ItemIronsword(ElementsKingswordMod instance) {
		super(instance, 629);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("kingsword:ironsword", "inventory"));
	}
