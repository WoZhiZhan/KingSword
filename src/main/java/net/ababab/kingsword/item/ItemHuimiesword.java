...
public class ItemHuimiesword extends ElementsKingswordMod.ModElement {
	@GameRegistry.ObjectHolder("kingsword:huimiesword")
	public static final Item block = null;
	public ItemHuimiesword(ElementsKingswordMod instance) {
		super(instance, 632);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("kingsword:huimiesword", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("huimiesword");
			setRegistryName("huimiesword");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add(Nb3.makeColour("充满了毁灭的力量！"));
			list.add("");
			list.add("\u5728\u4E3B\u624B\u65F6:");
			list.add(Nb.makeColour(" 毁灭万物") + Woodthree.makeColour(" 攻击速度"));
			list.add(Nb.makeColour(" 毁灭万物") + Woodthree.makeColour(" 攻击伤害"));
		}

		@Override
		public String getItemStackDisplayName(ItemStack Stack)
 		{
    		return Maxnb.makeColour("毁灭之刃");
  		}
