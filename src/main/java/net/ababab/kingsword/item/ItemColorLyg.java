...
import net.ababab.kingsword.procedure.ColorLyg;
...
public class ItemColorLyg extends ElementsKingswordMod.ModElement {
	@GameRegistry.ObjectHolder("kingsword:ColorLyg")
	public static final Item block = null;
	public ItemColorLyg(ElementsKingswordMod instance) {
		super(instance, 572);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("kingsword:colorlyg", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("colorlyg");
			setRegistryName("colorlyg");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ColorLyg.executeProcedure($_dependencies);
			}
			return ar;
		}
