...
public class ItemKillSword extends ElementsKingswordMod.ModElement {
	@GameRegistry.ObjectHolder("kingsword:kill_sword")
	public static final Item block = null;
	public ItemKillSword(ElementsKingswordMod instance) {
		super(instance, 792);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("KILL_SWORD", 1, 0, 4f, 0f, 2)) {
			@Override
		...
		public String getItemStackDisplayName(ItemStack Stack)
 		{
    		return Bao.makeColour("É±Â¾Ö®ÈÐ");
  		}
		...
		}.setUnlocalizedName("kill_sword").setRegistryName("kill_sword").setCreativeTab(TabKingice.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("kingsword:kill_sword", "inventory"));
	}
}
