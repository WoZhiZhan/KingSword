...
import net.ababab.kingsword.procedure.ProcedureXueXianShiYouXiNeiDieJiaCeng;
import net.ababab.kingsword.ElementsKingswordMod;

import com.google.common.collect.ImmutableMap;

@ElementsKingswordMod.ModElement.Tag
public class OverlayXue extends ElementsKingswordMod.ModElement {
	public OverlayXue(ElementsKingswordMod instance) {
		super(instance, 493);
	}
	...
	public static class GUIRenderEventClass {
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (ProcedureXueXianShiYouXiNeiDieJiaCeng.executeProcedure(ImmutableMap.of("world", world))) {
