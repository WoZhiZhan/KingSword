...
import net.ababab.kingsword.procedure.ProcedureDeadovaryXianShiYouXiNeiDieJiaCeng;
...
public class OverlayDeadovary extends GameOver implements OverlayDeadovar {

	public OverlayDeadovary(@Nullable ITextComponent p_i46598_1_) {
		super(p_i46598_1_);
	}
	...
	public static class GUIRenderEventClass {
		...
		@SubscribeEvent(priority = EventPriority.LOWEST) @SideOnly(Side.CLIENT)
    ...
    ProcedureDeadovaryXianShiYouXiNeiDieJiaCeng.executeProcedure(ImmutableMap.of(
            "world",
            world
    ))
) {
						...
						Minecraft.getMinecraft().renderEngine
									.bindTexture(new ResourceLocation("kingsword:textures/azz.png"));
