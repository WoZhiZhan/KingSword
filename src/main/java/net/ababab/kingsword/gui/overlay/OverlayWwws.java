...
import net.ababab.kingsword.procedure.ProcedureWwwsXianShiYouXiNeiDieJiaCeng;
import net.ababab.kingsword.ElementsKingswordMod;

import com.google.common.collect.ImmutableMap;

@ElementsKingswordMod.ModElement.Tag
public class OverlayWwws extends ElementsKingswordMod.ModElement {
	public OverlayWwws(ElementsKingswordMod instance) {
		super(instance, 384);
	}
	...
	public static class GUIRenderEventClass {
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (ProcedureWwwsXianShiYouXiNeiDieJiaCeng.executeProcedure(ImmutableMap.of("entity", entity, "world", world))) {
