...
public class GuiJswg extends ElementsKingswordMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiJswg(ElementsKingswordMod instance) {
		super(instance, 320);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("kingsword:textures/jswg.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("kingsword:textures/swgui.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + -279, this.guiTop + -83, 0, 0, 720, 450, 720, 450);
		}
