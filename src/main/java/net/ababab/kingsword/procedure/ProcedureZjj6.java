...
public class ProcedureZjj6 extends ElementsKingswordMod.ModElement {
	public ProcedureZjj6(ElementsKingswordMod instance) {
		super(instance, 178);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Zjj6!");
			return;
		}
