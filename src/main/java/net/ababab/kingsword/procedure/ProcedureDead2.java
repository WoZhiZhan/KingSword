...
public class ProcedureDead2 extends ElementsKingswordMod.ModElement {
	public ProcedureDead2(ElementsKingswordMod instance) {
		super(instance, 375);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dead2!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Dead2!");
			return;
		}
