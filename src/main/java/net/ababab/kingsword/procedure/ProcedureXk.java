...
import net.ababab.kingsword.item.ItemXkj;
...
public class ProcedureXk extends ElementsKingswordMod.ModElement {
	public ProcedureXk(ElementsKingswordMod instance) {
		super(instance, 214);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Xk!");
			return;
		}
		...
		for (Entity entityiterator : list) {
			if ((((entityiterator) instanceof EntityPlayer)
					? ((EntityPlayer) (entityiterator)).inventory.hasItemStack(new ItemStack(ItemXkj.block, (int) (1)))
					: false)) {
