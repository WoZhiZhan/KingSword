...
public class ProcedureCs10 extends ElementsKingswordMod.ModElement {
	public ProcedureCs10(ElementsKingswordMod instance) {
		super(instance, 462);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Cs10!");
			return;
		}
