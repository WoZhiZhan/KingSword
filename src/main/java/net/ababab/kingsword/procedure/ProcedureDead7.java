...
public class ProcedureDead7 extends ElementsKingswordMod.ModElement {
	public ProcedureDead7(ElementsKingswordMod instance) {
		super(instance, 380);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dead7!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Dead7!");
			return;
		}
