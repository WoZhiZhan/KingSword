...
public class ProcedureJsc extends ElementsKingswordMod.ModElement {
	public ProcedureJsc(ElementsKingswordMod instance) {
		super(instance, 169);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Jsc!");
			return;
		}
