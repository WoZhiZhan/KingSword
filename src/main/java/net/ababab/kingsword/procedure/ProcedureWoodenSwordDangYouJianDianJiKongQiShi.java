...
public class ProcedureWoodenSwordDangYouJianDianJiKongQiShi extends ElementsKingswordMod.ModElement {
	public ProcedureWoodenSwordDangYouJianDianJiKongQiShi(ElementsKingswordMod instance) {
		super(instance, 339);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		for (Entity entityiterator : list) {
			if ((!(((entityiterator) instanceof EntityPlayer)
					? ((EntityPlayer) (entityiterator)).inventory.hasItemStack(new ItemStack(ItemWoodenSword.block, (int) (1)))
					: false))) {
