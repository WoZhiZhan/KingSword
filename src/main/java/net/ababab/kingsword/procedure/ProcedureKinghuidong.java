...
public class ProcedureKinghuidong extends ElementsKingswordMod.ModElement {
	public ProcedureKinghuidong(ElementsKingswordMod instance) {
		super(instance, 528);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Kinghuidong!");
			return;
		}
		...
		if ((((entity instanceof EntityLivingBase) ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY)
				.getItem() == new ItemStack(ItemKingdesword.block, (int) (1)).getItem())) {
			{
				...
				if (!_ent.world.isRemote && _ent.world.getMinecraftServer() != null) {
					...
					}, "entitydata @e[type=!player,r=6] {NoAI:1b,Health:0,Invulnerable:0b,PersistenceRequired:0b,NoGravity:0b}");
				}
			}
			{
				Entity _ent = entity;
				if (!_ent.world.isRemote && _ent.world.getMinecraftServer() != null) {
					...
					}, "effect @e[type=!player,r=6] kingsword:jddsd");
				}
			}
		}
	}
