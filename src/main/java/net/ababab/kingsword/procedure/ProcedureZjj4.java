...
public class ProcedureZjj4 extends ElementsKingswordMod.ModElement {
	public ProcedureZjj4(ElementsKingswordMod instance) {
		super(instance, 176);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Zjj4!");
			return;
		}
