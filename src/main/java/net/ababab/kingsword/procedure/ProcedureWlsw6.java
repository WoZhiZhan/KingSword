...
public class ProcedureWlsw6 extends ElementsKingswordMod.ModElement {
	public ProcedureWlsw6(ElementsKingswordMod instance) {
		super(instance, 400);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Wlsw6!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Wlsw6!");
			return;
		}
