...
import net.ababab.kingsword.entity.Yellow;
import net.ababab.kingsword.item.ItemYellowsword;
...
public class ProcedureZazazaaz extends ElementsKingswordMod.ModElement {
	public ProcedureZazazaaz(ElementsKingswordMod instance) {
		super(instance, 339);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		for (int index0 = 0; index0 < (int) (100); index0++) {
			world.addWeatherEffect(new Yellow.EntityCustom(world, (int) Math.round(((x - 25) + (Math.random() * ((x + 25) - (x - 25))))), (int) y,
		...
		for (Entity entityiterator : list) {
			if ((!(((entityiterator) instanceof EntityPlayer)
					? ((EntityPlayer) (entityiterator)).inventory.hasItemStack(new ItemStack(ItemYellowsword.block, (int) (1)))
					: false))) {
