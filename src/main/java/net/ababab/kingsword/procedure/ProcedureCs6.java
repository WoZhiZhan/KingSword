...
public class ProcedureCs6 extends ElementsKingswordMod.ModElement {
	public ProcedureCs6(ElementsKingswordMod instance) {
		super(instance, 190);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Cs6!");
			return;
		}
