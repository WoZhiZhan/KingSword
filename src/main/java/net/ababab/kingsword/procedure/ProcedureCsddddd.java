...
public class ProcedureCsddddd extends ElementsKingswordMod.ModElement {
	public ProcedureCsddddd(ElementsKingswordMod instance) {
		super(instance, 204);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Csddddd!");
			return;
		}
