...
public class ProcedureFy5 extends ElementsKingswordMod.ModElement {
	public ProcedureFy5(ElementsKingswordMod instance) {
		super(instance, 165);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Fy5!");
			return;
		}
