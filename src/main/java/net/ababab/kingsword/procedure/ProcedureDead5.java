...
public class ProcedureDead5 extends ElementsKingswordMod.ModElement {
	public ProcedureDead5(ElementsKingswordMod instance) {
		super(instance, 378);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dead5!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Dead5!");
			return;
		}
