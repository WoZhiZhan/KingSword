...
import net.ababab.kingsword.entity.BlueLightningBolt;
...
public class ProcedureZazazaza extends ElementsKingswordMod.ModElement {
	public ProcedureZazazaza(ElementsKingswordMod instance) {
		super(instance, 339);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		for (int index0 = 0; index0 < (int) (100); index0++) {
			world.addWeatherEffect(new BlueLightningBolt.EntityCustom(world, (int) Math.round(((x - 25) + (Math.random() * ((x + 25) - (x - 25))))), (int) y,
		...
		for (Entity entityiterator : list) {
			if ((!(((entityiterator) instanceof EntityPlayer)
					? ((EntityPlayer) (entityiterator)).inventory.hasItemStack(new ItemStack(ItemLeitingzhiren.block, (int) (1)))
					: false))) {
