...
public class ProcedureKingdgji extends ElementsKingswordMod.ModElement {
	public ProcedureKingdgji(ElementsKingswordMod instance) {
		super(instance, 16);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Kingdgji!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure Kingdgji!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure Kingdgji!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure Kingdgji!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Kingdgji!");
			return;
		}
		...
		KingswordModVariables.MapVariables.get(world).syncData(world);
		{
			...
			if (mcserv != null)
				mcserv.getPlayerList().sendMessage(new TextComponentString("\u592A\u5F31\u4E86"));
		}
