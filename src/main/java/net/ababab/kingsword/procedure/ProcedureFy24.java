...
public class ProcedureFy24 extends ElementsKingswordMod.ModElement {
	public ProcedureFy24(ElementsKingswordMod instance) {
		super(instance, 310);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Fy24!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Fy24!");
			return;
		}
