...
public class ProcedureCs5 extends ElementsKingswordMod.ModElement {
	public ProcedureCs5(ElementsKingswordMod instance) {
		super(instance, 189);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Cs5!");
			return;
		}
