...
public class ProcedureWlsw7 extends ElementsKingswordMod.ModElement {
	public ProcedureWlsw7(ElementsKingswordMod instance) {
		super(instance, 401);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Wlsw7!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Wlsw7!");
			return;
		}
