...
public class ProcedureZjj1 extends ElementsKingswordMod.ModElement {
	public ProcedureZjj1(ElementsKingswordMod instance) {
		super(instance, 173);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Zjj1!");
			return;
		}
