...
public class ProcedureDead8 extends ElementsKingswordMod.ModElement {
	public ProcedureDead8(ElementsKingswordMod instance) {
		super(instance, 381);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dead8!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Dead8!");
			return;
		}
