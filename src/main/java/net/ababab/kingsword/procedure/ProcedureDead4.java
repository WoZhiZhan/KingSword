...
public class ProcedureDead4 extends ElementsKingswordMod.ModElement {
	public ProcedureDead4(ElementsKingswordMod instance) {
		super(instance, 377);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dead4!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Dead4!");
			return;
		}
