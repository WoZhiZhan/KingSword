...
public class Maxnb
{
  private static final TextFormatting[] colour = new TextFormatting[] { 
      TextFormatting.BLACK, TextFormatting.DARK_BLUE, TextFormatting.WHITE, TextFormatting.AQUA, TextFormatting.GOLD, TextFormatting.GREEN, TextFormatting.YELLOW, TextFormatting.DARK_GREEN, TextFormatting.DARK_PURPLE, TextFormatting.DARK_RED, TextFormatting.RED, TextFormatting.BOLD, TextFormatting.WHITE, TextFormatting.ITALIC, TextFormatting.BLUE, TextFormatting.WHITE };
