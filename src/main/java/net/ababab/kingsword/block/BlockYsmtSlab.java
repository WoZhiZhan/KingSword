...
public class BlockYsmtSlab extends ElementsKingswordMod.ModElement {
	@GameRegistry.ObjectHolder("kingsword:ysmt_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("kingsword:ysmt_slab_double")
	public static final Block block_slab_double = null;
	public BlockYsmtSlab(ElementsKingswordMod instance) {
		super(instance, 148);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ysmt_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ysmt_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("kingsword:ysmt_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("ysmt_slab");
