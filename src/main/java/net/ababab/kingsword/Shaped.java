...
public class Shaped
{
  private static final TextFormatting[] colour = new TextFormatting[] { 
      TextFormatting.RED, TextFormatting.GOLD, TextFormatting.YELLOW, TextFormatting.GREEN, TextFormatting.AQUA, TextFormatting.OBFUSCATED, TextFormatting.BLUE, TextFormatting.LIGHT_PURPLE, TextFormatting.DARK_AQUA, TextFormatting.DARK_BLUE, TextFormatting.DARK_GRAY, 
