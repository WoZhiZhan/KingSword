...
import net.ababab.kingsword.procedure.ProcedureF7AnXiaAnJianShi;
...
public class KeyBindingF7 extends ElementsKingswordMod.ModElement {
	private KeyBinding keys;
	public KeyBindingF7(ElementsKingswordMod instance) {
		super(instance, 172);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.f_7", Keyboard.KEY_F7, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureF7AnXiaAnJianShi.executeProcedure($_dependencies);
		}
	}
}
