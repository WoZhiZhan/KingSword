...
import net.ababab.kingsword.procedure.ProcedureKaiqi;
...
public class KeyBindingYj extends ElementsKingswordMod.ModElement {
	private KeyBinding keys;
	public KeyBindingYj(ElementsKingswordMod instance) {
		super(instance, 538);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.yj", Keyboard.KEY_Y, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureKaiqi.executeProcedure($_dependencies);
		}
	}
}
