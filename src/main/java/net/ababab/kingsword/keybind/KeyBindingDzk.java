...
import net.ababab.kingsword.procedure.ProcedureDzkDangMingLingBeiZhiXingShi;
...
public class KeyBindingDzk extends ElementsKingswordMod.ModElement {
	private KeyBinding keys;
	public KeyBindingDzk(ElementsKingswordMod instance) {
		super(instance, 590);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.dzk", Keyboard.KEY_B, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureDzkDangMingLingBeiZhiXingShi.executeProcedure($_dependencies);
		}
	}
}
