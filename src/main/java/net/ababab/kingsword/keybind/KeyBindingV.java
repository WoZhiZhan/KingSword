...
import net.ababab.kingsword.procedure.ProcedureVAnXiaAnJianShi;
...
public class KeyBindingV extends ElementsKingswordMod.ModElement {
	private KeyBinding keys;
	public KeyBindingV(ElementsKingswordMod instance) {
		super(instance, 171);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.v", Keyboard.KEY_V, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureVAnXiaAnJianShi.executeProcedure($_dependencies);
		}
	}
}
