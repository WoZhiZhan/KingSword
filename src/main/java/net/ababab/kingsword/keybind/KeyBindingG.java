...
import net.ababab.kingsword.procedure.ProcedureGAnXiaAnJianShi;
...
public class KeyBindingG extends ElementsKingswordMod.ModElement {
	private KeyBinding keys;
	public KeyBindingG(ElementsKingswordMod instance) {
		super(instance, 170);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.g", Keyboard.KEY_G, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureGAnXiaAnJianShi.executeProcedure($_dependencies);
		}
	}
}
