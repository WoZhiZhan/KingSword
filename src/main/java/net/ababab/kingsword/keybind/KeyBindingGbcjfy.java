...
import net.ababab.kingsword.procedure.ProcedureGnfjfy;
...
public class KeyBindingGbcjfy extends ElementsKingswordMod.ModElement {
	private KeyBinding keys;
	public KeyBindingGbcjfy(ElementsKingswordMod instance) {
		super(instance, 30);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.gbcjfy", Keyboard.KEY_J, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureGnfjfy.executeProcedure($_dependencies);
		}
	}
}
