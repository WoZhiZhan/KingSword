...
public final class GL11 {
	...
	static void nglClear(int mask, long function_pointer){
	...
	static void nglMatrixMode(int mode, long function_pointer) {
	...
	static void nglPushMatrix(long function_pointer){
	...
	static void nglTexImage2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, long pixels, long function_pointer) {}
